...
>
 <NavLink style={{color:'white',display:'flex',justifyContent:'center',marginRight:'32px'}} to="/profile">
   <UserOutlined style={{width:'32px',height:'32px',lineHeight:'30px',borderRadius:'20px',backgroundColor:'pink',color:'black'}} /><span className="text-success">hello!</span> 
 </NavLink>
</button>
...
<Layout className="site-layout" style={{backgroundColor:'#e8e8e8'}}>
  ...
  <Footer style={{ textAlign: 'center' }}>@ Admin Templates react movie 2022 PTB </Footer>
</Layout>
</Layout>
  </Fragment>
}}/>
